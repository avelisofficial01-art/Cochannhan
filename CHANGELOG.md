...
## Sprint 8: NPC INTERACTION & QUEST PROGRESSION HOTFIX — 2026-07-05

### Mục tiêu
Sửa các lỗi cản trở người chơi tương tác với NPC và thực hiện các chuỗi nhiệm vụ: click NPC không nhạy, hội thoại lặp đi lặp lại không tiến triển, lỗi mapping request payload khi lưu story flag, và lặp cutscene mở đầu khi di chuyển qua lại bản đồ.
...
| `frontend/src/game/GameScene.ts` | Sửa hitArea setInteractive của NPC, lưu trạng thái cutscene mở đầu trong localStorage. |
